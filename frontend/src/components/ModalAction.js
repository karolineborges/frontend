        ...
        <div>
            ...
            <Dialog open={open} onClose={handleCloseModal}>
                ...
                <DialogContent style={{ marginTop: "1vw" }}>
                    <DialogContentText>
                        {form === "add" ? <AddPet /> : form === "editPet" ? <EditDeletPet index={index.index}/> : ""}                        
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
